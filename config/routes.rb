Rails.application.routes.draw do
  ...
  get '/lessons/:category_id/lesson_words/', to: 'answers#new', :as => :learn_lesson
  get '/lessons/:category_id/lesson_words/?page=:nextpage', to: 'answer#new', :as => :continue_lesson
